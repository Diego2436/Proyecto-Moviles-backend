...
def cifrar(contrasena_plana, longitud_maxima=50):
    ...
    with open('empleados_data.txt', 'w') as file:
        for foodtruck in [foodtruck1, foodtruck2, foodtruck3]:
            for i in range(4):  # 4 employees per food truck (2 employees and 2 delivery persons)
                ...
                paswword_ci = cifrar(password_random)
                codigo = cifrar(str(random.randint(100000, 999999)), 10)
                ...
                usuario = Usuario.objects.create(email=correo, password=paswword_ci, codigo=codigo, verificacion="YES", tipo="employee")
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo', models.CharField(default=None, max_length=10, null=True)),
